      ...
      <div className='_navbar p-0 m-0'>
            <div className='add-shadow d-flex flex-nowrap justify-content-between ps-1 align-items-center p-0 py-1 '>
                ...
                <div className='d-flex flex-nowrap align-items-center'>                  
                    <Link to={'/enterprise'} className='btn px-1 mx-2 m-hide' >  Enterprise </Link>
                    <Link to={'/how-it-worked'} className='btn px-1 mx-2 m-hide' >  How it Works </Link>
                    <Link to={'/list-an-item'} className='btn px-1 mx-2 m-hide' >  List an Item </Link>
                     
                     {
                        isAuth ?         
                        <LoggedUserDropdown />
                             :
                       <button className='btn py-1 mx-2 m-hide login-signup-btn' data-bs-toggle='offcanvas' data-bs-target='#signup'> 
                               Login or Sign up
                      </button>
                     }
                    <span className=' hambuger me-2 me-md-3 px-1' data-bs-toggle='dropdown'></span>                
                    <ul className='dropdown-menu'>
                        <li className='d-sm-none'> 
                          {
                            !isAuth &&                                      
                               <span className='dropdown-item px-1 login-signup-btn' data-bs-toggle='offcanvas' data-bs-target='#signup'> 
                                 Login or Sign up
                               </span>
                           }   
                         </li>
                        <li><Link className='dropdown-item px-1' to={'/list-an-item'}>List an Item</Link></li>
                        <li><Link className='dropdown-item px-1' to={'/how-it-worked'}> How it Works</Link></li>
                        <li><Link className='dropdown-item px-1' to={'/enterprise'}>Enterprise</Link></li>                                                                                                  
                    </ul>
                </div>
            </div>   
