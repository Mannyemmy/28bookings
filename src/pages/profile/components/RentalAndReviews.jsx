  ...
  return (
    ...
    <ul className='nav nav-pills d-flex justify-content-center'>
        <li className='nav-item'>
            <a className='nav-link active py-1' data-bs-toggle='pill' href='#rental-shops'> Rental Shops </a>
        </li>
        <li className='nav-item'>
        ...
        <div className='tab-content mt-2 d-flex justify-content-center mb-4 mb-sm-3'>
            <div className='tab-pane active' id='rental-shops'> 
                  <img src={ require('../../../assets/coins.PNG') }
                   ...
                   <p className='text-center mb-1'>   Add a listing to start sharing and earning money.  </p>
